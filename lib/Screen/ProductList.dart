                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        child: Row(
                                          children: [
                                            Text(
                                                "Price: " + CUR_CURRENCY! + " " + price.toString() + "/",style: TextStyle(fontWeight: FontWeight.bold),),
          ...
          child: productList.length == 0
            ...
            children: [
              SizedBox(height: 50,),
                ...
                SizedBox(height: 10,),
                Text("Currently Unavailable,",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 15),),
               SizedBox(height: 20,),
