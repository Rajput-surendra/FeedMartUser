...
//     // });
//     // targetList.addAll([
//     //   TargetFocus(keyTarget: homeKey,contents:[
//     //     TargetContent(
...
//     //     ) )
//     //   ] ),
//     //   TargetFocus(keyTarget: catKey,contents:[
//     //     TargetContent(
//     //         padding: EdgeInsets.all(20),
//     //         align: ContentAlign.top,child: Column(
//     //       children: [
...
//     if (_isNetworkAvail) {
//       try {
//         var parameter = {ID: id, "state_id": "${stateid}"};
...
//             ? Container()
//             : IconButton(
//                 icon: SvgPicture.asset(imagePath + "search.svg",
//                     height: 20, color: Theme.of(context).colorScheme.darkMode),
//                 onPressed: () {
//                   Navigator.push(
//                       context,
//                       MaterialPageRoute(
...
//       //elevation: 2,
//       child: Showcase(
//         key: !keyFirst?GlobalKey():homeKey,
//         disableDefaultTargetGestures: false,
//         descTextStyle:TextStyle(
//           fontSize: 10.0,
//         ),
//         title: "Home",
//         description: 'Select tab is home',
...
//               padding: const EdgeInsets.all(4.0),
//               child: Showcase(
//                 key: !keyFirst?GlobalKey():videoKey,
//                 disableDefaultTargetGestures: false,
//                 descTextStyle:TextStyle(
//                   fontSize: 10.0,
//                 ),
//                 title: "Video",
//                 description: 'Tap on Video',
//                 child: Image.asset(
...
//               padding: const EdgeInsets.all(4.0),
//               child: Showcase(
//                 key: !keyFirst?GlobalKey():cartKey,
//                 disableDefaultTargetGestures: false,
//                 descTextStyle:TextStyle(
//                   fontSize: 10.0,
//                 ),
//                 title: "Cart",
//                 description: 'Tap on Cart',
//                 child: Image.asset(
//                   'assets/images/bottom4.png',
//                   height: 25.0,
//
//                   color:
//                       currentIndex == 3 ? colors.secondary : colors.secondary,
//                 ),
//               ),
//             ),
//             Container(
//               padding: const EdgeInsets.all(4.0),
//               child: Showcase(
//                 key: !keyFirst?GlobalKey():profile,
//                 disableDefaultTargetGestures: false,
//                 descTextStyle:TextStyle(
//                   fontSize: 10.0,
//                 ),
//                 title: "Profile",
//                 description: 'Tap on profile',
//                 child: Icon(
//                   Icons.person,
//                   size: 25,
//                   color:
//                       currentIndex == 4 ? colors.secondary : colors.secondary,
//                 ),
//               ),
//             ),
//           ],
