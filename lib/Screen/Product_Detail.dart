        ...
        try {
          ...
          if (int.parse(qty) < model.minOrderQuntity!) {
            ...
            Fluttertoast.showToast(
                msg: "${getTranslated(context, 'MIN_MSG')}$qty ${widget.model!.prVarientList![0].unittext}",
            ...
            //setSnackbar("${getTranslated(context, 'MIN_MSG')}$qty Tons", context);
          }
    ...
    return Column(children: <Widget>[
      ...
      Expanded(
          child: CustomScrollView(
              slivers: <Widget>[
                SliverAppBar(
                  expandedHeight: MediaQuery.of(context).size.height * .42,
                  floating: false,
                  pinned: true,
      ...
      try {
        if (notificationisloadmore) {
          ...
          await post(getProductApi, headers: headers, body: parameter)
              .timeout(Duration(seconds: timeOut));
          print("this is a Api===========>${getProductApi.toString()}");
          print(parameter.toString());
