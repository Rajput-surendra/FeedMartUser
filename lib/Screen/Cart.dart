                                  ...
                                  child: Stack(
                                    children: [
                                      TextField(
                                        ...
                                        controller: _controller[index],
                                        decoration: InputDecoration(
                                          prefixText: "Qty :",hintStyle: TextStyle(color: colors.blackTemp),
                                          // prefix: Text("QTY: "),
                                          border: InputBorder.none,
      ...
      try {
        ...
        if (!error) {
          ...
          setState(() {
            ...
            finalAmount = getdata['sub_total'].toString();
  ...
  Future<Null> _getSaveLater(String save) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        await post(getCartApi, body: parameter, headers: headers)
            .timeout(Duration(seconds: timeOut));
        print("this is s--------->${getCartApi.toString()}");
      ...
      try {
        ...
        if (!error) {
          ...
          List<SectionModel> uptcartList = (cart as List)
              .map((cart) => new SectionModel.fromCart(cart)).toList();
