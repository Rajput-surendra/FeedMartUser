...
//
//   //
//   // final whatsapppBoxKey = GlobalKey(debugLabel: "whatsapppBoxKey");
//   // final contactBoxKey = GlobalKey(debugLabel: "contactBoxKey");
//   // final cateBoxKey = GlobalKey(debugLabel: "cateBoxKey");
//   // final searchBoxKey = GlobalKey(debugLabel: "searchBoxKey");
//   // final youtubeBoxKey = GlobalKey(debugLabel: "youtubeBoxKey");
//   // final facebookBoxKey = GlobalKey(debugLabel: "facebookBoxKey");
//   // final instaBoxKey = GlobalKey(debugLabel: "instaBoxKey");
//   // final notificationBoxKey = GlobalKey(debugLabel: "notificationBoxKey");
//
...
//   // }
//
//   GlobalKey<CurvedNavigationBarState> homeAllket = GlobalKey();
//   static final whatsapp = GlobalKey(debugLabel:'whatsappKey');
//   static final phone = GlobalKey(debugLabel:'phoneKey');
//   static final category = GlobalKey(debugLabel:'categoryKey');
//   static final search = GlobalKey(debugLabel:'searchKey');
//   static final youtube = GlobalKey(debugLabel:'youtube');
//   static final instagram1 = GlobalKey(debugLabel:'instagram1');
//   static final facebook1 = GlobalKey(debugLabel:'facebook1');
//   static final noti = GlobalKey(debugLabel:'noti');
//   // // static final homeKey = GlobalKey(debugLabel:'homeyKey');
//   // // static final catKey = GlobalKey(debugLabel:'catKey');
//   // // static final videoKey = GlobalKey(debugLabel:'videoKey');
//   // // static final cartKey = GlobalKey(debugLabel:'cartKey');
...
//                             ),
//                             Showcase(
//                               key: !keyFirst1?GlobalKey():youtube,
//                               disableDefaultTargetGestures: false,
//                               descTextStyle:TextStyle(
//                                 fontSize: 10.0,
//                               ),
//                               title: "Social media",
//                               description: 'Tap on Social',
//                               child: Row(children: [
//                                 // Showcase(
//                                 // key: !keyFirst1?GlobalKey():youtube,
//                                 // disableDefaultTargetGestures: false,
...
//                                 SizedBox(width: 12,),
//                                 // Showcase(
//                                 // key: !keyFirst1?GlobalKey():facebook1,
//                                 // disableDefaultTargetGestures: false,
//                                 // descTextStyle:TextStyle(
//                                 //   fontSize: 10.0,
//                                 // ),
//                                 // title: "Facebook",
//                                 // description: 'Tap on Facebook',
//                                 //child:
//                                 InkWell(
...
//                                 SizedBox(width: 12,),
//                                 // Showcase(
//                                 //   key: !keyFirst1?GlobalKey():instagram1,
//                                 //   disableDefaultTargetGestures: false,
//                                 //   descTextStyle:TextStyle(
//                                 //     fontSize: 10.0,
//                                 //   ),
//                                 //   title: "Instagram",
//                                 //   description: 'Tap on Instagram',
//                                 //   child:
//                                 InkWell(
...
//                                 SizedBox(width: 11,),
//                                 ///Showcase(
//                                 // key: !keyFirst1?GlobalKey():noti,
//                                 // disableDefaultTargetGestures: false,
//                                 // descTextStyle:TextStyle(
//                                 //   fontSize: 10.0,
//                                 // ),
//                                 // title: "Notification",
//                                 // description: 'Tap on Notification',
//                                 // child:
//                                 InkWell(onTap: (){
//                                   Navigator.push(context, MaterialPageRoute(builder: (context)=>NotificationList()),
//                                   );
...
//                         padding: const EdgeInsets.only(left: 15),
//                         child: Showcase(
//                           key: !keyFirst1?GlobalKey():category,
//                           disableDefaultTargetGestures: false,
//                           descTextStyle:TextStyle(
//                             fontSize: 10.0,
//                           ),
//                           title: "Category",
//                           description: 'Tap on Category',
//                           child: InkWell(
//                               onTap: (){
//                                 //  startTutorialMode();
//                               },
//                               child: Text(
//                                 "Categories",style: TextStyle(color: colors.blackTemp,fontWeight: FontWeight.bold,fontSize: 18),)),
//                         ),
//                       ),
//                       _catList(),
//                       Row(
...
//                 padding: const EdgeInsets.only(left: 20),
//                 child: Showcase(
//                   key: !keyFirst1?GlobalKey():phone,
//                   disableDefaultTargetGestures: false,
//                   descTextStyle:TextStyle(
//                     fontSize: 10.0,
//                   ),
//                   title: "Phone",
//                   description: 'Select tab is Phone',
//                   child: Container(
//                     height: 45.0,
//                     width: 45.0,
//                     child: FloatingActionButton(
...
//               SizedBox(height: 10,),
//               Showcase(
//                 key: !keyFirst1?GlobalKey():whatsapp,
//                 disableDefaultTargetGestures: false,
//                 descTextStyle:TextStyle(
//                   fontSize: 10.0,
//                 ),
//                 title: "Whatsapp",
//                 description: 'Select tab is Whatsapp',
//                 child: Container(
//                   //key: whatsapppBoxKey,
//                   height: 50.0,
//                   width: 50.0,
...
//           padding: const EdgeInsets.only(left: 8.0,right: 8),
//           child: Showcase(
//             key: !keyFirst1?GlobalKey():search,
//             disableDefaultTargetGestures: false,
//             descTextStyle:TextStyle(
//               fontSize: 10.0,
//             ),
//             title: "Search",
//             description: 'Tap on Search',
//             child: Container(
//                 height: 40,
//                 decoration: BoxDecoration(
//                     color: colors.whiteTemp,
